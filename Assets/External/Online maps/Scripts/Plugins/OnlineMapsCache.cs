...
public class OnlineMapsCache:MonoBehaviour
{
    ...
    {
        Texture2D texture = new Texture2D(0, 0, TextureFormat.RGB24, map.control.mipmapForTiles);
    ...
    private bool TryLoadTraffic(OnlineMapsTile tile)
    {
        ...
        Texture2D trafficTexture = new Texture2D(256, 256, TextureFormat.RGB24, map.control.mipmapForTiles);
